        ...
        <div id="page-container" class="sidebar-inverse side-scroll page-header-fixed main-content-boxed">
            ...
            <main id="main-container">
                <div class="content">
                    <div class="row">
                        <div id="demo" class="carousel slide" data-ride="carousel" data-interval="false" data-pause="hover">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="transpa carousel-caption bg-dark">
                                    <h3>Bersama Bank Indonesia</h3>
                                    <p>Undangan untuk buka bersama!</p>
                                </div>   
                                </div>
                            </div>
                    ...
                    “Yayasan ini Bukanlah <strong>Ajaran Tertentu</strong>, Bukan <strong>Ajang Bisnis</strong>, Bukan tempat <strong>Jual Beli</strong> ILMU / PERDUKUNAN. Kami tidak bisa apa-apa dan tidak punya apa-apa. Semua yang kami lakukan karena <strong>ALLAH</strong> Ta'ala. Kami hanya perantara. Mari jadikan yayasan ini sebagai penegak syariat Islam yang dituntunkan/disunnahkan Baginda <strong>Nabi Muhammad SAW</strong>. Semoga Allah Melindungi,Mencukupi dan Mengijabahi Aamiin.....”
                    </p>
                        ...
                        <div class="row items-push js-gallery img-fluid-100">
                                ...
                                <div class="options-container fx-item-zoom-in fx-overlay-slide-down">
                                    ...
                                    <div class="options-overlay bg-black-op-75">
                                        <div class="options-overlay-content">
                                            <h4 class="h3 text-white-op mb-15">Istighosah</h4>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 animated fadeIn">
                                <div class="options-container fx-item-zoom-in fx-overlay-slide-down">
                                    ...
                                    <div class="options-overlay bg-black-op-75">
                                        <div class="options-overlay-content">
                                            <h4 class="h3 text-white-op mb-15">TPQ-Anak</h4>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 animated fadeIn">
                                <div class="options-container fx-item-zoom-in fx-overlay-slide-down">
                                    ...
                                    <div class="options-overlay bg-black-op-75">
                                        <div class="options-overlay-content">
                                            <h4 class="h3 text-white-op mb-15">Pengajian Rutin</h4>
                                        </div>
                                    </div>
